...
def muove4():
        ...
        cfg.messaggirx.put((time.time(),'sleep;3'))
        cfg.stato[0]=1
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3A0'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3D1000'))
        time.sleep(0.2)
        ...
        cfg.messaggirx.put((time.time(),'sleep;3'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3A90'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3D1000'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3R6'))
        ...
        cfg.messaggirx.put((time.time(),'sleep;3'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3A180'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3D1000'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3R6'))
        ...
        cfg.messaggirx.put((time.time(),'sleep;3'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3A270'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3D1000'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3R6'))
...
def movehome():
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'3T10'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'hom;0'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'sleep;5'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'3T45'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'hom;1'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'sleep;5'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'3T90'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'hom;2'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'sleep;5'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'3T135'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'hom;3'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'sleep;5'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'3T170'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'hom;4'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'sleep;5'))
    time.sleep(0.2)
    cfg.messaggirx.put((time.time(),'3T90'))
...
def muovefun():
    print("distanza libera",cfg.dist_libera)
    if cfg.dist_libera>600:
        cfg.stato[0]=1
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'1r'))
        time.sleep(0.2)
        ...
        cfg.messaggirx.put((time.time(),'1r'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'1q70+110+5'))
        cfg.time_radar=1
        ...
        print("troppo vicino2")
        newa=math.degrees(float(cfg.posatt[3]))+90
        print("angolo",newa)
        #
        cfg.messaggirx.put((time.time(),'sleep;2'))
        cfg.stato[0]=1
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3A'+str(newa)))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3D10'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'3R6'))
        time.sleep(0.2)
        cfg.messaggirx.put((time.time(),'1r'))
...
def calcola_movimento():
    p1=[float(cfg.posatt[1]),float(cfg.posatt[2])]
    p2=cfg.percorso.pop()
    print(p1,p2)
    dst=distanza_punti(p1, p2)
    ang=angolo_base(p1, p2)
    ang=ang*-1
    return int(dst),int(ang)
